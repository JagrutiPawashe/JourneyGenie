...
st.set_page_config(page_title="🚗🧳✈️JourneyGenie – Simplifying your travel plans!!!")
st.image('tour.png', width=70)
st.header("✈️🧳🚗JourneyGenie – Simplifying your travel plans!!!")
...
if section_choice == "Trip Planner":
    ...
    if submit1:
        ...
        st.subheader("Let's Plan it around : ")
        st.write(response)
...
if section_choice == "Weather Forecasting":
    ...
    if submit1:
        response = get_response(input_prompt_planner, input_plan)
        st.subheader("Is the weather alright?: ")
        st.write(response)
